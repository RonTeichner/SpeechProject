...
if enableSentenceDetection:
    sentencesEstimationResultsTrain = createSentencesDataset(metadata, path2SentencesResultsTrain, path2SentencesMetadataTrain, path2SentencesFeaturesTrain, path2SentencesAudioTrain, path2SentencesPitchTrain, path2WordModels, path2SpeakerModels, path2GenderModels, chosenFeatures, nSentences=100000, whichSet='train')
